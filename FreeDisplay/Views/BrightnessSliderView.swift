...
struct BrightnessSliderView: View {
    ...
    var body: some View {
        VStack(spacing: 2) {
            ...
            .help(display.isBuiltin ? "System brightness: control built-in display brightness via system API" : "DDC: hardware directly controls brightness\nSoftware: adjust brightness via software")
